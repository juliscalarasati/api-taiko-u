  ...
  owner: [
    {
      ...
      factor: "INS",
      questions: [
        { id: "OH1", text: "Apakah bisnis Anda sudah memiliki izin usaha resmi (NIB/SIUP)?", type: "choice", options: ["Tidak", "Sedang Proses", "Ya"] },
        { id: "OH2", text: "Apakah bisnis Anda pernah menerima bantuan pendanaan dari pemerintah atau lembaga terkait?", type: "choice", options: ["Tidak", "Sedang Proses", "Ya"] },
        { id: "OH3", text: "Apakah bisnis Anda pernah mengikuti pelatihan atau program pengembangan usaha?", type: "choice", options: ["Tidak", "Sedang Proses", "Ya"] },
        { id: "OH4", text: "Apakah bisnis Anda pernah bekerja sama atau berkolaborasi dengan bisnis lain dalam menjalankan usaha?", type: "choice", options: ["Tidak", "Sedang Proses", "Ya"] },
        { id: "OH5", text: "Apakah bisnis Anda sudah menggunakan media digital atau media sosial untuk pemasaran?", type: "choice", options: ["Tidak", "Sedang Proses", "Ya"] },
        { id: "OH6", text: "Dari mana sumber modal utama bisnis Anda saat ini?", type: "card", options: ["Modal Sendiri", "Keluarga/Teman", "Pinjaman Bank"] }
      ]
    },
    {
      menu: "Budaya",
      ...
      factor: "OV",
      questions: [
        { id: "OH26", text: "Bisnis memiliki sumber daya operasional yang cukup untuk menjalankan aktivitas sehari-hari.", type: "scale" }
      ]
    },
    {
      menu: "Operasional",
      ...
      factor: "OPS",
      questions: [
        { id: "OH27", text: "Bisnis mampu memenuhi kewajiban kepada karyawan tepat waktu.", type: "scale" },
        { id: "OH28", text: "Mesin atau peralatan operasional bekerja dengan baik dan optimal.", type: "scale" },
        { id: "OH29", text: "Pasokan bahan baku atau kebutuhan operasional tersedia dengan lancar.", type: "scale" },
        { id: "OH30", text: "Permintaan pelanggan terhadap produk/jasa dapat diprediksi dengan baik.", type: "scale" },
        { id: "OH31", text: "Bisnis memiliki hubungan pelanggan yang baik dalam jangka panjang.", type: "scale" }
      ]
    },
    {
      menu: "Keuangan",
      ...
      factor: "ECT",
      questions: [
        { id: "OH32", text: "Bisnis memiliki kemampuan untuk menjangkau pasar atau pelanggan baru.", type: "scale" },
        { id: "OH33", text: "Penjualan atau omzet bisnis mengalami peningkatan dalam satu tahun terakhir.", type: "scale" },
        { id: "OH34", text: "Bisnis mampu memenuhi kewajiban operasional dan keuangan dengan baik.", type: "scale" },
        { id: "OH35", text: "Kondisi operasional bisnis berjalan sehat dan lancar secara keseluruhan.", type: "scale" }
      ]
    }
  ],
  ...
  karyawan: [
    {
      ...
      factor: "LDI",
      questions: [
        { id: "OH7", text: "Pemilik usaha memiliki hubungan yang dekat dan baik dengan karyawan.", type: "scale" },
        { id: "OH8", text: "Pemilik usaha memberikan contoh etos kerja yang baik kepada bawahannya.", type: "scale" },
        { id: "OH9", text: "Pemilik usaha terbuka terhadap ide dan masukan dari karyawan.", type: "scale" },
        { id: "OH10", text: "Pemilik usaha terlibat langsung dalam kegiatan operasional bisnis.", type: "scale" },
        { id: "OH11", text: "Pemilik usaha ikut membimbing atau melatih karyawan baru.", type: "scale" },
        { id: "OH12", text: "Pemilik usaha bersikap adil dalam memberikan penghargaan maupun teguran kepada karyawan.", type: "scale" }
      ]
    },
    {
      ...
      factor: "WEQ",
      questions: [
        { id: "OH13", text: "Tempat kerja memiliki kondisi yang aman dan minim risiko kecelakaan kerja.", type: "scale" },
        { id: "OH14", text: "Saya merasa puas dengan pengaturan jam kerja di tempat usaha ini.", type: "scale" },
        { id: "OH15", text: "Beban kerja yang diberikan masih sesuai dan dapat ditangani dengan baik.", type: "scale" },
        { id: "OH16", text: "Kondisi fisik tempat kerja seperti pencahayaan, suhu, dan kebersihan terasa nyaman.", type: "scale" },
        { id: "OH17", text: "Karyawan jarang mengalami ketidakhadiran atau absen kerja.", type: "scale" }
      ]
    },
    {
      ...
      factor: "OV",
      questions: [
        { id: "OH18", text: "Karyawan saling membantu ketika ada rekan kerja yang mengalami kesulitan.", type: "scale" },
        { id: "OH19", text: "Hubungan antar karyawan berjalan dengan baik dan harmonis.", type: "scale" },
        { id: "OH20", text: "Komunikasi antar sesama rekan kerja berjalan dengan terbuka.", type: "scale" },
        { id: "OH21", text: "Karyawan merasa nyaman bekerja di lingkungan usaha ini.", type: "scale" },
        { id: "OH22", text: "Karyawan memiliki rasa tanggung jawab terhadap pekerjaannya.", type: "scale" },
        { id: "OH23", text: "Karyawan disiplin terhadap aturan dan waktu kerja.", type: "scale" },
        { id: "OH24", text: "Karyawan saling menghormati tanpa membedakan latar belakang.", type: "scale" },
        { id: "OH25", text: "Karyawan mampu bekerja sama dengan baik dalam tim.", type: "scale" }
      ]
    }
  ]
};
...
const answerKey = `kuesionerAnswers_${activeUser.user_id}`;
...
function renderMenu() {
  stepMenu.innerHTML = sections.map((section, index) => `
...
function renderStep() {
  ...
  questionContainer.innerHTML = section.questions.map(q => renderQuestion(q)).join("");

  prevBtn.style.visibility = currentStep === 0 ? "hidden" : "visible";
  nextBtn.textContent = currentStep === sections.length - 1 ? "Selesai & Simpan" : "Selanjutnya →";
...
function getOptionDesc(option) {
  ...
  if (option === "Keluarga/Teman") return "Pinjaman non-formal tanpa bunga tinggi.";
  if (option === "Pinjaman Bank") return "Kredit usaha atau fasilitas perbankan.";
  return "";
}
...
function validateCurrentSection() {
  ...
  const emptyQuestion = section.questions.find(q =>
...
nextBtn.addEventListener("click", async () => {
  ...
  const filteredAssessments = assessments.filter(item =>
    !(item.user_id == activeUser.user_id && item.user_role === activeUser.role)
  );
...
function calculateAssessmentResult() {
  ...
  return {
    ...
    nama_umkm: activeUser.umkm.nama_umkm,
    sektor: activeUser.umkm.sektor,
